...
s1.async=true;
s1.src='https://embed.tawk.to/62af10c0b0d10b6f3e781b38/1g5ttis50';
s1.charset='UTF-8';
    ...
    <div class="row">
      <div class="col-xs-12 col-md-3">
        <div class="row" style="margin-bottom: 5px;">
          <div class="col-md-12"><img src="{{ asset('frontend/images/img1.jpg') }}" class="img-thumbnail"></div>
        </div>
        <div class="row" style="margin-bottom: 5px;">
          <div class="col-md-12"><img src="{{ asset('frontend/images/img2.jpg') }}" class="img-thumbnail"></div>
        </div>
        <div class="row">
          <div class="col-md-12"><img src="{{ asset('frontend/images/img3.jpg') }}" class="img-thumbnail"></div>
        </div>
      </div>
      <div class="col-md-9"> 
        <!-- slide -->
          ...
          <div class="item"> 
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel"> 
              ...
              <div class="carousel-inner">
                <div class="item active"> <img src="{{ asset('frontend/images/la.jpg') }}" alt="Los Angeles"> </div>
                <div class="item"> <img src="{{ asset('frontend/images/slideshow1221b.jpg') }}" alt="Los Angeles"> </div>
                <div class="item"> <img src="{{ asset('frontend/images/chicago.jpg') }}" alt="Chicago"> </div>
...
<script src="{{ asset('assets/frontend/100/047/633/themes/517833/assets/elevate-zoom221b.js?1481775169361') }}" type="text/javascript"></script> 
<script src="{{ asset('assets/frontend/100/047/633/themes/517833/assets/main221b.js?1481775169361') }}" type='text/javascript'></script> 
<script src="{{ asset('assets/frontend/100/047/633/themes/517833/assets/ajax-cart221b.js?1481775169361') }}" type='text/javascript'></script>
</body>
</html>